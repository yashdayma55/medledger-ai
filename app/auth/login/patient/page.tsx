...
export default async function LoginPatientPage({ searchParams }: Props) {
  ...
  return (
    <main className="min-h-screen flex flex-col items-center justify-center px-6 py-12">
      ...
      <div className="w-full max-w-md">
        ...
        <PatientLoginForm errorFromUrl={errorFromUrl} />
        ...
        <p className="mt-4 text-center">
          <Link href="/auth/patient" className="text-slate-400 hover:text-slate-300 underline text-sm">
